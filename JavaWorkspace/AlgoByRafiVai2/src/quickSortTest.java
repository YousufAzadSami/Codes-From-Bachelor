...
public class quickSortTest extends JApplet implements ActionListener, Runnable {
        ...
        private void quickSort(int first, int last) {
    		...
    		jLabelGridArr[pivotIndex].setBackground(Color.RED);
    		...
    		while(i<j){
    			...
    			while( Integer.parseInt( jLabelGridArr [i].getText() ) < pivot){
    				...
    				if(i != 0){
    					jLabelGridArr[i-1].setBackground(Color.LIGHT_GRAY);
    				}
    			}
    			...
    			if(jLabelGridArr[i].getText() == jLabelGridArr[j].getText()	 ){
    				i++;
    			}
