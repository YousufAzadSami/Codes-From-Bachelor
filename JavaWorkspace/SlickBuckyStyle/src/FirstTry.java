...
public class FirstTry extends BasicGame{
    ...
    public void init(GameContainer gc) throws SlickException {
    	...
    	background = new Image("d:\\backOpu.jpg");
    	bar = new Image("d:\\gamebar2.jpg");
    }
    ...
    public void update(GameContainer gc, int delta) throws SlickException     
    {
    	...
    	if(xPosBall >= (800-CIRCLE_RADIUS))
    	{
    		updateMultiplierX = -updateMultiplierX;
    		xPosBall = 800 - CIRCLE_RADIUS - 2;
    	}
    	else if(xPosBall<=0)
    	{
    		updateMultiplierX = -updateMultiplierX;
    	...
    	if(yPosBall >= (600-CIRCLE_RADIUS))
    	{
    		updateMultiplierY = -updateMultiplierY;
    		yPosBall = 600 - CIRCLE_RADIUS - 2;
    	}
    	else if( yPosBall<=00)
    	{
    		updateMultiplierY = -updateMultiplierY;
    	...
    	*/
    	...
    	if( xBallLeftPoint >= xPosBar1+15 - 3 && xBallLeftPoint<= xPosBar1+15 + 3)
    	...
    	//if( xBallLeftPoint == BAR_BORDER_GAP+BAR_WIDTH-1 )
    	{
    		...
    		{    			
    			...
    			xPosBall = xPosBar1+15 + 4;
    			updateMultiplierX = -updateMultiplierX;
    			
    			if((yPosBar1+32 <= yBallLeftPoint) && (yBallLeftPoint < yPosBar1+48))
    			{
    				xUpdateFraction = 0.4f;
    				yUpdateFraction = 0.0f;
    				str=3;
    			}
    	...
    	//if( xBallRightPoint >=800 - BAR_WIDTH - BAR_BORDER_GAP - 3 && xBallRightPoint<= 800 - BAR_WIDTH - BAR_BORDER_GAP + 3)
        	...
        	//if( xBallLeftPoint == BAR_BORDER_GAP+BAR_WIDTH-1 )
        	{
        		...
        		{        			
        			...
        			if((yPosBar2+32 <= yBallLeftPoint) && (yBallLeftPoint < yPosBar2+48))
        			{
        				xUpdateFraction = 0.4f;
        				yUpdateFraction = 0.0f;
        				str2=3;
