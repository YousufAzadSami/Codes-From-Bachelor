...
public class SequentialSearchThreadTimer extends JApplet implements ActionListener {
		...
		private boolean flagForTimer = false;
        ...
        private void Search() {
                ...
                if(flagForTimer == true)
                {  	
                	// JUST DELAY ER CODE TA 
                	try{
                		Thread.sleep(2000);
                	}catch(InterruptedException e){
                		System.out.println("Exception with Thread Timer...");
                	}
                	// JUST DELAY ER CODE TA
                }
